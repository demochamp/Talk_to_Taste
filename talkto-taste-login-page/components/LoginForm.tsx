          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none transition-all duration-300 transform hover:scale-105 ${
                  errors.email ? 'border-red-500 focus:border-red-600 animate-shake' : 'border-gray-200 focus:border-orange-500 focus:shadow-lg focus:shadow-orange-200'
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="••••••••"
                className={`w-full px-4 pr-12 py-3 border-2 rounded-lg focus:outline-none transition-all duration-300 transform hover:scale-105 ${
                  errors.password ? 'border-red-500 focus:border-red-600 animate-shake' : 'border-gray-200 focus:border-orange-500 focus:shadow-lg focus:shadow-orange-200'
                } bg-gray-50 focus:bg-white`}
              />
              <button
                type="button"
